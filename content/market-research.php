<section id="market-research">
	...
	<section id="business-analysis">
		...
		<h4 class="heading-3" id="overview">1.1.1. Overview</h4>
		...
		<h4 class="heading-3" id="canvas-business-model">1.1.2. Canvas Business Model</h4>
		<img src="imgs/canvas-business-model.png" alt="Canvas Business Model">

		<h4 class="heading-3" id="services">1.1.3. Services</h4>
		...
		<h4 class="heading-3" id="positioning">1.1.4. Positioning</h4>
	</section>
	...
	<section id="target-analysis">
		...
		<section id="project-peter">
			...
			<table>
				...
				<tr>
					<th>Bio</th>
					<td>Frank has an Ivy League education on business, and he counts with 15+ years of experience in business. He was leading a business development team at Accenture, working on projects for Nike until, during the uncertain time of the Covid pandemic, he decided to make use of his gathered professional experience to start a venture of his own. He bootstraped his initial efforts investing money from his own pocket into his business project. He came up with a name for his company himself, he registered the webdomain of the company himself, he posted a job on Upwork to get a quick logo done by a cheap designer, and he created his business' website himself on Wix. He reached out to a few close, like-minded, experienced colleagues with whom he has worked previously on other business and offered them to be a part of the team he's leading. After a couple of months of launching his business, he closed a long-term contract for continuous consulting services for a large corporation. This allowed him to expand his team hiring an executive assistant and formalize other aspects of his business like bookkeeping so he doesn't have to take care of everything completely by himself. Now that the business has some dough and a couple of regular clients he wants to scale his operation to take in new, bigger clients to really make a difference in the income the consulting firm generates. However, as a savvy business person, he realizes that the quick logo that he got done for cheap and the Wix website he created himself do not express the level of professionalism he's hoping to communicate to potential clients.</td>
				</tr>
				<tr>
					<th>Problem</th>
					<td>He is the Founder & CEO of an emerging company in the Business Consulting sector but their Brand Identity doesn’t reflect the high quality of their services.</td>
				</tr>
				<tr>
					<th>Solution</th>
					<td>(End-to-End Project contract) Finding a reliable team of experts who can translate his vision for the business into a compelling brand identity and a website with user experience that delivers a good, professional, trustworthy impression to prospects and interests them in becoming paying clients.</td>
				</tr>
				<tr>
					<th>How will they measure success?</th>
					<td>Having an increase in the number of meetings scheduled with leads every month.</td>
				</tr>
				<tr>
					<th>Brands they follow</th>
					<td>Forbes, Bloomberg, Business Insider, Inc., Ted Talks, Ideo, Deloitte, Accenture, The Wall Street Journal, The Economist, Harvard Business Review, Entrepreneur.</td>
				</tr>
			</table>
		</section>
		<section id="consulting-catherine">
			...
			<table>
				...
				<tr>
					<th>How will they measure success?</th>
					<td>Increase in the number of monthly sign-ups and lower churn rate.</td>
				</tr>
				<tr>
					<th>Brands they follow</th>
					<td></td>
		...
		<section id="augmentation-andrew">
			<h4 class="heading-3">Augmentation Andrew</h4>
			<table>
				<tr>
					<th>Portrait</th>
					<td></td>
				...
				<tr>
					<th>Bio</th>
					<td>Dave is a self-made man. He didn't went to a top college, but he still committed himself fully to his professional career burning the midnight oil to get new clients for a marketing agency where he had a junior sales rep role. He climbed up the corporate ladder being head-hunted for better and better positions. He developed wonderful relationships with loyal clients and made himself a name in the industry. One year ago, the founder and CEO of new marketing agency he used to work with as a client offered him a steady position at the company being his right-hand man in keeping the revenue growing.</td>
				</tr>
				<tr>
					<th>Problem</th>
					<td>The inhouse team already has a heavy workload and the C-level wants to keep growing the revenue with new clients but they don't want to hire a bunch of new employees and have to deal with the management and budgeting risks that come with scaling the business.</td>
				</tr>
				<tr>
					<th>Solution</th>
				...
				<tr>
					<th>How will they measure success?</th>
					<td>Customers commenting to accounts executives that they are very satisfied with their results and want to continue working with the Marketing Agency.</td>
				</tr>
				<tr>
					<th>Brands they follow</th>
					<td></td>
		...
		<section id="follower-felicia">
			<h4 class="heading-3">1.3.4. Follower Felicia</h4>
			<table>
				<tr>
					<th>Portrait</th>
					<td></td>
